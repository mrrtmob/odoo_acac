...
class ComercialInvoiceNoTax(models.AbstractModel):
    _name = "report.pm_accounting.report_commercial_invoice_no_tax"
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report = report_obj._get_report_from_name('module.pm_accounting.report_commercial_invoice_no_tax')
