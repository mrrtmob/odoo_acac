...
class TaxInvoice(models.AbstractModel):
    _name = "report.pm_accounting.report_tax_invoice"
    ...
    def _get_report_values(self, docids, data=None):
        print('hit tax invoice')
        report_obj = self.env['ir.actions.report']
        report = report_obj._get_report_from_name('module.pm_accounting.report_tax_invoice')
        ...
        for term in self:
            #Define Semester
            semesters = term.semester_ids #get many semesters
            for semester in semesters:
                #ilterate semester
                semester.name = "updated"
