...
class StockMove(models.Model):
    ...
    actual_cost = fields.Float('Actual Cost', currency_field="currency_id")
    estimated_cost = fields.Float('Estimated Cost', currency_field="currency_id")
    ...
    def _on_change_actual_cost(self):
        print('-----******-------')
        self.product_id.write({
            'supplier_unit_cost': self.actual_cost
        })
